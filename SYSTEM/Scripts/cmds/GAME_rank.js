...
const defaultFontName = 'BeVietnamPro-Bold';
...
global.YukiBot.makeRankCard = makeRankCard;
...
module.exports = {
	...
	atCall: async function ({ message, event, usersData, threadsData, commandName, envCommands, api }) {
		deltaNext = 5;
		let targetUsers;
	...
	atChat: async function ({ usersData, event }) {
