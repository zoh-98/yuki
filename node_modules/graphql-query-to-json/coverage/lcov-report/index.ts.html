...
<span class="cline-any cline-yes">18x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {parse} from "graphql"
...
const getArguments = (args) =&gt; {
    ...
    args.forEach((arg) =&gt; {
        ...
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (arg.selectionSet) {
<span class="cstat-no" title="statement not covered" >            argsObj[arg.name.value] = getSelections(arg.selectionSet.selections)</span>
...
export const graphQlQueryToJson = (
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (parsedQuery.definitions.length &gt; 1) {
<span class="cstat-no" title="statement not covered" >        throw new Error(`The parsed query has more than one set of definitions`)</span>
    }
    // @ts-ignore
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Fri Nov 19 2021 13:00:12 GMT+0000 (Greenwich Mean Time)
            </div>
        </div>
